    ...
    <>
      ...
      {(koSelected || endureSelected) &&
        <div className="search-buttons-row">
          ...
          <button className="chart-btn"
            onClick={() => {
              setClicked(true)
              searchDex(koSelected, endureSelected, typeDropdownValue, powerInput.current.value, selected.name)
            }}>search</button>
        </div>
      }
      <div className="chart-area">
        {clicked ? (
          ...
          <span className="chart-placeholder">Click the button above to see the result</span>
        )}
      </div>
    </>
  );
